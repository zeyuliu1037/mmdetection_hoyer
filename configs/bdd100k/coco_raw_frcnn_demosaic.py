...
img_norm_cfg = dict(
    ...
    # mean=[103.530, 103.530, 103.530], std=[1.0, 1.0, 1.0], to_rgb=False)
train_pipeline = [
...
data = dict(
    train=dict(
        ...
        ann_file='/nas/home/zeyul/mmdetection/data/ann/instances_maxitrainX4.json'),
    val=dict(
        pipeline=test_pipeline,
        img_prefix='/nas/home/gdatta/raw_image_contents/demosaiced_image/',
        ann_file='/nas/home/zeyul/mmdetection/data/ann/instances_minivalX4.json'),
    test=dict(
        pipeline=test_pipeline,
        img_prefix='/nas/home/gdatta/raw_image_contents/demosaiced_image/',
        ann_file='/nas/home/zeyul/mmdetection/data/ann/instances_minivalX4.json'))
...
work_dir = 'work_dirs/coco_raw/frcnn_lr_0.01_after_demosaic_new'
load_from = 'checkpoints/faster_rcnn_r50_caffe_fpn_mstrain_3x_coco_20210526_095054-1f77628b.pth' # Ori mAP: 39.9
# resume_from = 'work_dirs/coco_raw/frcnn/lr_0.002_donot_frozen/epoch_5.pth'
