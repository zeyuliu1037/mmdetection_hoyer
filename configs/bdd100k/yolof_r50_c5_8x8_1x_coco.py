...
data = dict(
    ...
    test=dict(pipeline=test_pipeline,
              ...
              classes=classes,
              ann_file='data/raw_dataset/test_annotations.json'
                ))
...
# python tools/test.py configs/yolof/yolof_r50_c5_8x8_1x_coco.py checkpoints/yolof_r50_c5_8x8_1x_coco_20210425_024427-8e864411.pth --eval bbox
